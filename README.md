...
> 메인넷이란 기존에 존재하는 플랫폼에 종속되어 있지 않고, 독립적으로 생태계를 구성하는 것이다.
...
> 특정 시점의 코인(블록체인)을 중단 하고, 상태를 기록하는 작업이다. 에어드랍 또는 하드포크 같은 작업에 사용하게 된다. 스냅샷은 특정 블록 번호를 명확시 명시하여 해당 블록의 내용을 보관하는 것이다.
...
> [메인넷]이 되지 전에 독자적인 플랫폼으로 자리잡을 수 있는지 테스트를 하는 생태계를 말한다.
-----
